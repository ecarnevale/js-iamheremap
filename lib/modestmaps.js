...
com.modestmaps.Map = function(parent, provider, dimensions) {
    ...
    */
    ...
    com.modestmaps.addEvent(this.parent, 'touchstart', this.getMouseDown());
    ...
    getMouseDown: function() {
        if (!this.mouseDownHandler) {
            ...
            this.mouseDownHandler = function(e) {
                ...
                com.modestmaps.addEvent(document, 'touchend', theMap.getMouseUp());
                com.modestmaps.addEvent(document, 'touchmove', theMap.getMouseMove());
    ...
    getMouseUp: function() {
        if (!this.mouseUpHandler) {
            ...
            this.mouseUpHandler = function(e) {
                ...
                com.modestmaps.removeEvent(document, 'touchend', theMap.getMouseUp());
                com.modestmaps.removeEvent(document, 'touchmove', theMap.getMouseMove());
